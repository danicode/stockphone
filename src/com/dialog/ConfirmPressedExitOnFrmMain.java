...
public class ConfirmPressedExitOnFrmMain extends Builder {
	
	private boolean pressedButtonOPk = false;

	public ConfirmPressedExitOnFrmMain(Context context) {
		super(context);
		this.setTitle(R.string.lblTitleConfirm);
		this.setMessage(R.string.lblMessageConfirmPressedExitOnFrmMain);
