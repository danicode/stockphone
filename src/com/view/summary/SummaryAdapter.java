...
public class SummaryAdapter extends ArrayAdapter<ArticleDTO> {
	...
	public SummaryAdapter(Context context, int resource,
			int textViewResourceId, ArrayList<ArticleDTO> listArticle) {
		super(context, resource, textViewResourceId, listArticle);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {			
			...
			holder.lblStockItemCodArticle = (TextView) convertView.findViewById(R.id.lblSummaryItemCodArticle);
			holder.lblStockItemDescription = (TextView) convertView.findViewById(R.id.lblSummaryItemDescription);
			holder.lblStockItemCodArtivleProvider = (TextView) convertView.findViewById(R.id.lblSummaryItemCodArticleProvider);
			holder.lblStockItemQuantity = (TextView) convertView.findViewById(R.id.lblSummaryItemQuantity);
		...
		if(articleDTO != null) {
			...
			holder.lblStockItemQuantity.setText(articleDTO.getQuantity());
		}
