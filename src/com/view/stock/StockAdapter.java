...
public class StockAdapter extends ArrayAdapter<ArticleDTO> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {			
			...
			holder.lblStockItemCodArticle = (TextView) convertView.findViewById(R.id.lblStockItemCodArticle);
			holder.lblStockItemDescription = (TextView) convertView.findViewById(R.id.lblStockItemDescription);
			holder.lblStockItemCodArtivleProvider = (TextView) convertView.findViewById(R.id.lblStockItemCodArticleProvider);
